...
export default function ShiftPlanner() {
  ...
  function onSubmitDayShift() {
    console.log("Day shift submit clicked");
    if (!selectedDate) {
      toast({
        title: "Fout",
  ...
  function onSubmitNightShift() {
    console.log("Night shift submit clicked");
    if (!selectedDate) {
      toast({
        title: "Fout",
        description: "Selecteer eerst een datum",
